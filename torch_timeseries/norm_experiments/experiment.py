...
class NormExperiment(Settings):
    ...
    def _process_batch(self, batch_x, batch_y, batch_x_date_enc, batch_y_date_enc):
        """
        This function will handle the forward pass of the batch, returning both predictions and truth values.
        The implementation of this function depends on your specific model architecture.
        """
        # Example: Assuming `self.model` is a callable model
        preds = self.model(batch_x, batch_x_date_enc)  # Make predictions
        truths = batch_y  # Ground truth
        return preds, truths
